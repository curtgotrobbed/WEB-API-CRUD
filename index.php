...
include "../TASK-APP-API/config/db.php";
...
//Handle if request does not exist
$request = isset($_GET['request']) ? explode(separator: "/",string: trim(string: $_GET['request'],characters: "/")):[];
